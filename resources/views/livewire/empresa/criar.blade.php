<x-modal wire:model="modal" title="Nova empresa" separator class="backdrop-blur" box-class="min-w-3xl">
    <x-form wire:submit="salvar" id="criar-empresa-form">
        ...
        <x-slot:actions>
            ...
            <x-button label="Salvar" type="submit" class="bg-blue-600 text-white" form="criar-empresa-form"/>
        </x-slot:actions>
    </x-form>
</x-modal>
